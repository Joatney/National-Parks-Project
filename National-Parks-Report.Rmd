...
This data set shows off the immense biodiversity in these national parks, with over forty thousand unique species of plants and animals found across all 56 of the parks. Vascular plants make up the majority of species recorded by the National Park Service, as shown below:  
...
This graph represents the presence of a certain category of species in a park.  

Your eyes may be drawn to the category "Vascular Plants" which is recorded overwhelmingly more than the other categories of species. Because this category includes ferns, flowers, trees, and trees, it is understandable why it might account for so many different species. Not only are there lots of trees in national parks, there are often lots of different types of trees (with an estimated 60,000+ species of trees found globally). Conservation organizations like the IUCN or the National Parks Services often focus their efforts of maintaining biodiversity in trees and other vascular plants, partially because there are simply so many of them.  

Because there are so many species of vascular plant in the original data set, we had to remove them from later analysis so that we could look more closely at trends.

## Conservation Efforts
The National Parks Service, which runs all of the national parks in the United States, is federally controlled and federally funded. The service is a bureau of the U.S. Department of the Interior, and it is headed by a Director appointed by the President and confirmed by the U.S. Senate.^[https://www.nps.gov/aboutus/index.htm] This Director creates the budget for the national parks, sets programs, and creates policies regarding the parks. If there is anybody who is able to help get funds and support to the parks that need it most, it is the Director of the National Parks Service.  
...
Of all of the species that were assigned a conservation status, 83.4% of them were assigned Species of Concern, which we thought was too high to be normal. What we assumed to have happened was that the people in the National Parks Service who gathered the data used lay terms and general groupings when assigning conservation status. Some of them must have thrown any species of any concern category into "Species of Concern" rather than a more specific grouping.  
...
If birds are in greater need of support, then they could be used as an indicator of which parks (or for our purposes, which states) are most in need of support. Of course, the bird factor alone would not be enough to tell us for sure, but we knew that if we could find a state with a greater number of birds, had a high proportion of species of concern, and had other factors making that state need support, we would have a well-founded idea of which state answers our question.  

So, the first thing we did was we looked at the category counts for each state, pulling out which was the highest. For these purposes, we removed vascular plants (because we know already that they are not hugely of concern and we could expect them to be the most common in every state if we kept them in).  
...
Most states have more species of birds (compared to other categories) than anything else, which makes sense considering they were the second highest category after vascular plants. Several states showed other values, mainly in insects, but for the purposes of using birds as indicators of concern, we can exclude those states. They likely do not have enough birds to be important to this consideration.  
...
This graph shows that, of states where birds are the most common species after vascular plants, California has the highest number of unique bird species with over 2,000 represented across its national parks. This suggests that California could be the state that needs the most financial support. Looking at more numeric indicators, we can focus on California and see whether the amount of concern lines up with this evidence.  
...
There are two states that are tied for having the highest number of parks: Alaska and California. Some states like Idaho and Colorado have a slightly higher amount compared to the rest, but no state is able to rival the eight parks in both Alaska and California. California now has two factors contributing to it: the bird indicator and the number of parks.  
...
The numbers here are low, but that is to be expected, as we already know that most species are not of concern. What this trend shows, though, is that Alaska still has few species of concern, with a percentage just above 3% of total species, whereas California is much higher, with the other southwestern states at just about 6%.  
...
Another standout is Utah, but because it does not stand out in any other visualization, we did not focus on this.
...
Here is a heat map of California which shows the density of species of concern across the state. This map shows a correlation to one of the most problematic - highly populated and heavily polluted - locations in the country, and the only one of those locations where there is a National Park present. Because of that, we see that there is the most amount of concern regarding endangered animals in Southern California with the most 142 species of concern in Channel Islands National Park which is located just outside of Los Angeles. We find from this map that there is correlation, which hints at a causation, towards human development being the root cause of the diminishment of global biodiversity. Because we have all of this information, we can now conclude where the National Park Service should direct a majority of their funds. 
...
What this suggests to us is that California could be doing much better, and that it needs more support than any other state to rectify its environmental issues.  
