...
There are 63 congressionally delegated national parks in the United States as of 2022, each with its own diverse wildlife. The data set we used for this project only focuses on 56 of these national parks. Some of these are excluded because the data set was uploaded to the repository in 2017, before several of them were established. Others, though, we excluded because they did not have data available. The 56 national parks that are included in the ["Biodiversity in National Parks" data set](https://www.kaggle.com/datasets/nationalparkservice/park-biodiversity) are mapped out here:
